...
try:
    from .tools import catalog_query, trace_lineage, check_quality, get_client, set_client

    __all__.extend(["catalog_query", "trace_lineage", "check_quality", "get_client", "set_client"])
except ImportError:
